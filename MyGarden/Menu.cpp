...
std::optional<int> MenuSingle::show_options_menu(ConsoleEngine& engine, int width, int heigth,
                                  int pos_x, int pos_y,
...
MenuSingle::MenuSingle(ConsoleEngine& engine, int width, int height, int pos_x,
    ...
    : Menu(engine, width, height, pos_x, pos_y), options(options) {draw();}
...
std::optional<std::vector<MenuCountOption>> MenuCount::show_options_menu(ConsoleEngine& engine, int width, int heigth,
                                 int pos_x, int pos_y,
